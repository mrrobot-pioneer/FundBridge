"""
Django settings for fundbridge project.
...
SECRET_KEY = 'django-insecure-g-gu9rj(khllox4a$z*=!dm+n-y*eb(%$y-2(q-(&e&a7z@g_q'
...
WSGI_APPLICATION = 'fundbridge.wsgi.application'
